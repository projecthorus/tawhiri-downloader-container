...
- Downloaded data sets are stored in `/srv/tawhiri-datasets`, these need to be made avilable to [_tawhiri-container_](https://github.com/projecthorus/tawhiri-container). It is recommend that `/srv` is shared using a method such as a bind mount or volume.
